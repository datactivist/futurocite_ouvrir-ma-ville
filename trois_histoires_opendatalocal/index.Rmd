...
* [le menu des cantines scolaires](https://opendata.larochelle.fr/dataset/restauration-enfance-archives-des-menus-des-restaurants-scolaires/) sur l'open data de La Rochelle ;
* [la réutilisation par l'application Quiditmiam](https://opendata.larochelle.fr/utilisation-des-jeux-de-donnees-menus-par-quiditmiam/).
...
## Histoire #2 : Du formulaire PDF à la carte ouvertes
